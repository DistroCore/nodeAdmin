...
| TD-6  | OAuth `exchangeOAuthCode()` 为 mock 实现，无 GitHub/Google token exchange 调用 — OAuth 登录不可用                                                                                                                                                                                                                                         | 🔴 高                 | §9.2 审计                     |
| TD-7  | SMS 验证码用 `Math.random()` 生成，短信未接入真实供应商 — 短信登录不可用                                                                                                                                                                                                                                                                  | 🔴 高                 | §9.2 审计                     |
| TD-8  | `authService.ts` 日志打印明文 SMS 验证码 — 安全隐患                                                                                                                                                                                                                                                                                       | 🔴 高                 | §9.2 审计                     |
| TD-9  | 5 个 Controller 硬编码 `tenantId ?? 'default'` 回退                                                                                                                                                                                                                                                                                       | 🟡 中                 | §9.2 审计                     |
| TD-10 | `menusService.ts` 菜单 ID 用 `Math.random()` 生成，应改 `crypto.randomUUID()`                                                                                                                                                                                                                                                             | 🟡 中                 | §9.2 审计                     |
| TD-11 | `auditLogService.ts` DB 不可用时用内存数组 (限 200 条)                                                                                                                                                                                                                                                                                    | 🟡 中                 | §9.2 审计                     |
| TD-12 | 前端 5 文件硬编码 API URL `http://${hostname}:11451` 回退                                                                                                                                                                                                                                                                                 | 🟡 中                 | §9.2 审计                     |
| TD-13 | 前端 3 页面 `useState('default')` 硬编码 tenantId                                                                                                                                                                                                                                                                                         | 🟡 中                 | §9.2 审计                     |
| TD-14 | 前端 4 处使用 `console.error` 而非结构化日志                                                                                                                                                                                                                                                                                              | 🟢 低                 | §9.2 审计                     |
| TD-15 | `runtimeConfig.ts` 6 处硬编码默认值                                                                                                                                                                                                                                                                                                       | 🟢 低                 | §9.2 审计                     |
| TD-16 | 前端 5 处硬编码 polling interval                                                                                                                                                                                                                                                                                                          | 🟢 低                 | §9.2 审计                     |
| TD-17 | `notificationPanel.tsx` 使用 emoji 图标而非 SVG design system                                                                                                                                                                                                                                                                             | 🟢 低                 | §9.2 审计                     |
| TD-18 | `messagePanel.tsx` dev-token 端点回退，生产需确保禁用                                                                                                                                                                                                                                                                                     | 🟢 低                 | §9.2 审计                     |
